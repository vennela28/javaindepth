...
byte b = 50;
updateProfile(b);  the compiler picks up #4 as it is more specific than 1 i.e. it is next larger datatype after byte
...
boolean updateProfile(int newId) {} - compiler will complain that we have a duplicate method. We get a compilation error
...
public class MethodOverloading{
	...
	public static void main(String... args){
		...
		byte b = 10;
		go(b);    // #3 is invoked 10 is an byte literal and the compiler would pick #3 which is the most specific next compatible datatype.
	}
}